...
/// metadata was fetched from. Providers that delegate auth to a different
/// domain than the MCP endpoint (Freshworks: freshservice.com endpoint,
/// myfreshworks.com issuer) fail that check despite serving valid metadata.
